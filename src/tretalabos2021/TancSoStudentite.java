...
public class TancSoStudentite {
    ...
    static Semaphore garderobaEden;
    static Semaphore garderobaDva;

    static Semaphore accessSala;

    static Semaphore zenskoHere;
    static Semaphore weCanLeave;


    public void init() {
        //TODO: da se implementira
        garderobaEden = new Semaphore(10);
        garderobaDva = new Semaphore(10);

        accessSala = new Semaphore(3);

        zenskoHere = new Semaphore(0);
        weCanLeave = new Semaphore(0);
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
            garderobaEden.acquire();
            show.presobleci();
            // samo maskoto go povikuva metodot tancuvaj
            zenskoHere.acquire();
            garderobaEden.release();
    ...
    class Zensko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
            garderobaDva.acquire();
            show.presobleci();
            zenskoHere.release();
            garderobaDva.release();
            weCanLeave.acquire();
        }
